...
//        System.out.println("");
    ...
    public void printTable(List list,int limit){
        System.out.println("||"+td.getName()+"||");
        System.out.println("-------------------------------------------------------");
        if(list==null){
            BPlusTreeTool.printBPlusTree(tree,td,limit);
        }else{
            BPlusTreeTool.printBPlusTree(list,td,limit);
        }
    ...
    public void printTable(List list){
        ...
        System.out.println("-------------------------------------------------------");
        if(list==null){
            BPlusTreeTool.printBPlusTree(tree,td,-1);
        }else{
            BPlusTreeTool.printBPlusTree(list,td,-1);
        }
